...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo lang('footer_copyright'); ?> &copy; <?php echo date('Y'); ?>.</strong> <?php echo lang('footer_all_rights_reserved'); ?>.<span style="float:right;">Made with ♥ by <a href="http://www.techjindal.com/" target="_blank">Tech Jindal</a> in India.</span>
            </footer>
        </div>
