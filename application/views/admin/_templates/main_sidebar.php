                    ...
                    <ul class="sidebar-menu">
                        ...
                        <!--<li class="<?=active_link_controller('groups')?>">
                            <a href="<?php echo site_url('admin/groups'); ?>">
                                <i class="fa fa-shield"></i> <span><?php echo lang('menu_site_layout'); ?></span>
                            </a>
                        </li>
                        ...
                        <li class="<?=active_link_controller('donation')?>">
                            <a href="<?php echo site_url('admin/donation'); ?>">
                                <i class="fa fa-file"></i> <span><?php echo lang('donation'); ?></span>
                            </a>
                        </li>
                         <li class="<?=active_link_controller('cms')?>">
                            <a href="<?php echo site_url('admin/cms'); ?>">
                                <i class="fa fa-file"></i> <span>Site Pages</span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('contact')?>">
                            <a href="<?php echo site_url('admin/contact'); ?>">
                                <i class="fa fa-envelope"></i> <span>Contact Form</span>
                            </a>
                        </li>
                        <li class="treeview <?=active_link_controller('settings')?>">
                            <a href="#">
                             ...
                             <ul class="treeview-menu">
                             <li class="<?=active_link_function('settings')?>">
                                <a href="<?php echo site_url('admin/settings/logo'); ?>"><?php echo lang('menu_site_logo'); ?></a>
                            </li>
                             </ul>
                                                        <ul class="treeview-menu">
                                <li class="<?=active_link_function('settings')?>">
                                <a href="<?php echo site_url('admin/settings/seo'); ?>"><?php echo lang('menu_seo'); ?> </a></li>
                            </ul>
                             <ul class="treeview-menu">
                                <li class="<?=active_link_function('settings')?>">
                                <a href="<?php echo site_url('admin/settings/ads'); ?>"><?php echo lang('menu_ads'); ?> </a></li>
                            </ul>
                             <ul class="treeview-menu">
                            <li class="<?=active_link_function('settings')?>">
                                <a href="<?php echo site_url('admin/settings/call2action'); ?>"><?php echo lang('menu_site_calltoaction'); ?></a>
                            </li>
                        </ul>
                         <ul class="treeview-menu">
                                <li class="<?=active_link_function('settings')?>">
                                <a href="<?php echo site_url('admin/settings/site'); ?>"><?php echo lang('menu_site'); ?> </a></li>
                            </ul>
                             <ul class="treeview-menu">
                                <li class="<?=active_link_function('settings')?>">
                                <a href="<?php echo site_url('admin/settings/customcss'); ?>"><?php echo lang('menu_custom_css'); ?> </a></li>
                            </ul>
